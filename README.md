...
No configuration is needed: pi-retry ships with 11 retry rules and one context-compaction rule. See the [recovery specification](openspec/specs/error-recovery/spec.md) for the exact defaults and behavior.
